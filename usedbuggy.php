...
<div class="usedbuggy-page">
    ...
    <form class="usedbuggy-search-bar" method="get" action="usedbuggy.php">
        <div class="usedbuggy-keyword-field">
            <input
                type="text"
                name="keyword"
        ...
        <div class="usedbuggy-price-range-field">
            <div class="usedbuggy-price-field">
                <select name="min_price" id="usedMinPrice">
                ...
                <span class="usedbuggy-price-divider"></span>

                <select name="max_price" id="usedMaxPrice">
        ...
        <div class="usedbuggy-seat-field">
            <select name="seats">
        ...
        <div class="usedbuggy-brand-field">
            <select name="brand">
        ...
        <div class="usedbuggy-year-field">
            <select name="year">
        ...
        <div class="usedbuggy-sort-field">
            <select name="sort">
        ...
        <div class="usedbuggy-button-field">
            <button type="submit" class="usedbuggy-search-btn">Search</button>
        </div>
    </form>
