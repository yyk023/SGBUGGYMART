...
// Fetch side ads for "side_accessories"
$sideAds = [];
try {
    $adStmt = $pdo->prepare("
        SELECT * FROM banners
        WHERE type = 'ad' AND location = 'side_accessories' AND status = 'active'
...
<div class="acc-page">
    ...
    <form class="ubuggy-search-bar" method="get" action="accessories.php" id="ubuggyMainForm">
        <input type="text" class="ubuggy-search-input" name="keyword" placeholder="Search accessories..." value="<?php echo e($keyword); ?>">
