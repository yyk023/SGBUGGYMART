...
<div class="breadcrumb">
    <a href="accessory-list.php">Accessories</a> &gt; <span><?php echo $isEdit ? 'Edit Accessory' : 'Add Accessory'; ?></span>
</div>
    ...
    <div id="infoTab" class="tab-panel <?php echo $activeTab === 'infoTab' ? 'active' : ''; ?>">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <div class="help">Used to filter accessories by category on the public accessories page.</div>
            </div>
        ...
        <?php if ($isEdit): ?>
            <div class="form-actions">
                <button class="btn" type="submit" name="save_accessory" value="1">Save Changes</button>
                <a href="accessory-list.php" class="btn btn-secondary">Cancel</a>
            </div>
            </form>
        <?php endif; ?>
    </div>
                        ...
                        <div class="gallery-card">
                            <div class="gallery-actions">
                                ...
                                <form method="post">
                                    ...
                                    <input type="hidden" name="gallery_id" value="<?php echo (int)$gallery['id']; ?>">
                                    <button type="submit" class="image-action-btn remove-btn" onclick="return confirm('Remove this image?');">
                                        Remove
                                    </button>
                                </form>
                            </div>
