...
if ($token === '') {
    ...
    try {
        ...
        } elseif ((int)$seller['email_verified'] === 1) {
            $status  = 'already';
            $message = 'Your email is already verified. You can log in now.';
        } elseif (strtotime($seller['token_expires_at']) < time()) {
            $status  = 'expired';
...
<style>
    ...
    .verify-btn:hover { background: #d92e3d; color: #fff; }
    ...
    .verify-btn-outline:hover { background: #ef3f4d; color: #fff; }
</style>
...
<div class="verify-page">
    <div class="verify-box">
        ...
        <?php elseif ($status === 'expired'): ?>
            ...
            <h1>Link Expired</h1>
            <p><?php echo htmlspecialchars($message); ?></p>
            <form method="post" action="seller-auth.php" style="margin-top:8px;">
